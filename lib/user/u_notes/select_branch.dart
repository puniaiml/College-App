...
import 'package:college_app/user/u_notes/select_semester.dart';
...
class SelectBranch extends StatefulWidget {
  ...
  const SelectBranch({super.key, required this.selectedCollege});

  @override
  State<SelectBranch> createState() => _SelectBranchState();
}

class _SelectBranchState extends State<SelectBranch> with TickerProviderStateMixin {
  ...
  void _navigateToSemesterPage(BuildContext context, String branch) {
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SelectSemesterUserPage(
          branch: branch,
