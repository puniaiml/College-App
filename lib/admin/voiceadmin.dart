...
// import 'package:college_app/user/u_notes/college_pick.dart';
import 'package:college_app/user/result.dart';
import 'package:college_app/user/u_time_table/branch.dart';
import 'package:college_app/user/u_time_table/college_user.dart';
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  void navigateToPage(String textSpeech) {
    ...
    if (textSpeech.contains('notes')) {
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const BranchUser(selectedCollege: '',)),
      );
      ...
      Navigator.push(
        context,
        MaterialPageRoute(builder: (context) => const CollegeUserPage()),
      );
