...
import 'package:college_app/admin/a_notes/subject_management.dart';
...
class SelectSemesterPage extends StatelessWidget {
  final String selectedCollege;
  final String branch;

  const SelectSemesterPage({super.key, required this.branch, required this.selectedCollege});
