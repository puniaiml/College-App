import 'package:college_app/admin/a_notes/select_semester.dart';
...
class SelectBranchAdmin extends StatelessWidget {
  final String selectedCollege; // Declare the selectedCollege variable

  const SelectBranchAdmin({super.key, required this.selectedCollege});
  ...
  void _navigateToSemesterPage(BuildContext context, String branch) {
    // Navigate to the SelectSemesterPage and pass the selected college
    Navigator.push(
      context,
      MaterialPageRoute(
        builder: (context) => SelectSemesterPage(branch: branch, selectedCollege: selectedCollege), // Pass selectedCollege
      ),
    );
  }
}
